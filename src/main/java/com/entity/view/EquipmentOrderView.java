...
public class EquipmentOrderView extends EquipmentOrderEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	//当前表
	//订单类型的值
	@ColumnInfo(comment="订单类型的字典表值",type="varchar(200)")
	private String equipmentOrderValue;

	//支付类型的值
	@ColumnInfo(comment="支付类型的字典表值",type="varchar(200)")
	private String equipmentOrderPaymentValue;
	...
	public EquipmentOrderView(EquipmentOrderEntity equipmentOrderEntity) {
		try {
			BeanUtils.copyProperties(this, equipmentOrderEntity);
	...
	//当前表的
	//获取： 订单类型的值
	public String getEquipmentOrderValue() {
		return equipmentOrderValue;
	}

	//设置： 订单类型的值
	public void setEquipmentOrderValue(String equipmentOrderValue) {
		this.equipmentOrderValue = equipmentOrderValue;
	}

	//当前表的
	// 获取： 支付类型的值
	public String getEquipmentOrderPaymentValue() {
		return equipmentOrderPaymentValue;
	}

	//设置： 支付类型的值
	public void setEquipmentOrderPaymentValue(String equipmentOrderPaymentValue) {
		this.equipmentOrderPaymentValue = equipmentOrderPaymentValue;
	}
	...
	public String toString() {
		return "EquipmentOrderView{" +
			", equipmentOrderValue=" + equipmentOrderValue +
			", equipmentOrderPaymentValue=" + equipmentOrderPaymentValue +
