      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          ...
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = " linear-gradient(120deg, rgba(41, 142, 71, 0.8)10%, var(--publicMainColor)100%)"
...
.index-aside {
  ...
  .menulist-item {
    ...
    background: linear-gradient(to right, var(--publicMainColor) 0%, var(--publicMainColor) 50%, var(--publicMainColor) 100%) !important;
